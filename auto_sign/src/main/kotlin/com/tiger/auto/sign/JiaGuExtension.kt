...
open class JiaGuExtension(
    ...
    open fun fir(action: Action<Fir>) {
        action.execute(fir)
    }
...
class Fir() {
    ...
    lateinit var firApiToken: String // fir api token  必填
    lateinit var firChangeLog: String //更新日志
    override fun toString(): String {
        return "Fir(firApiToken='$firApiToken', firChangeLog='$firChangeLog')"
    }
